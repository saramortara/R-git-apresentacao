...
```{r}
knitr::include_graphics("https://raw.githubusercontent.com/liibre/R-git/master/figs/03-rj_nowcasting.png")
```
...
- [Rmarkdwn](https://rmarkdown.rstudio.com) :)
--
...
---
## a gente está acostumada escrever e formatar
